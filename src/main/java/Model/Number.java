...
public class Number {
     ...
     */
    public Number(int posted_by, String message_text, long time_posted_epoch) {
     ...
     * @param time_posted_epoch
     */
    public Number(int message_id, int posted_by, String message_text, long time_posted_epoch) {
